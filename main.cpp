...
#include <string>
#include <cstdlib>
//to get it running in windows get VS or CLion with minGW or cygwin on windows(ofcours ull need boost then on windows -.-)
...
tcp::endpoint ep(ip::address::from_string("192.168.2.114"),8001);
